...
const Header = styled.header`
  ...
  background: linear-gradient(
    ...
    ${(p) =>
        p.theme.mode === "dark"
          ? "rgba(21,20,21,0.7)"
          : "rgba(241,234,222,0.85)"}
      0%,
    ${(p) =>
        p.theme.mode === "dark"
          ? "rgba(21,20,21,0.3)"
          : "rgba(241,234,222,0.4)"}
      50%,
    transparent 100%
  );
...
const NavBtn = styled(Link)`
  ...
  &:hover {
    border-color: ${(p) => p.theme.navTextHover};
    color: ${(p) => p.theme.navTextHover};
    background: ${(p) =>
      p.theme.mode === "dark"
        ? "rgba(241,234,222,0.06)"
        : "rgba(21,20,21,0.04)"};
  }
  @media (max-width: 768px) {
    display: none;
...
const ThemeBtn = styled.button`
  ...
  &:hover {
    color: ${(p) => p.theme.navTextHover};
    border-color: ${(p) => p.theme.navBorder};
  }
  @media (max-width: 480px) {
    padding: 6px 10px;
    font-size: 10px;
